...
team2 = {"npc_dota_hero_antimage", "npc_dota_hero_axe", "npc_dota_hero_pudge",
"npc_dota_hero_crystal_maiden", "npc_dota_hero_puck"};
team3 = {"npc_dota_hero_antimage", "npc_dota_hero_axe", "npc_dota_hero_pudge",
"npc_dota_hero_crystal_maiden", "npc_dota_hero_puck"};
team4 = {"npc_dota_hero_antimage", "npc_dota_hero_axe", "npc_dota_hero_pudge",
"npc_dota_hero_crystal_maiden", "npc_dota_hero_puck"};
team5 = {"npc_dota_hero_antimage", "npc_dota_hero_axe", "npc_dota_hero_pudge",
"npc_dota_hero_crystal_maiden", "npc_dota_hero_puck"};
