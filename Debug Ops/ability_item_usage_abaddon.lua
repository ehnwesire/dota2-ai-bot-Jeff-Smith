...
local 1 = "abaddon_death_coil";
local 2 = "abaddon_aphotic_shield";
local 3 = "abaddon_frostmourne";
local 4 = "abaddon_borrowed_time";    


local t1 = "special_bonus_exp_boost_20"
local t2 = "special_bonus_armor_6"
local t3 = "special_bonus_attack_damage_90"
local t4 = "special_bonus_unique_abaddon"
local unselected1 = "special_bonus_movement_speed_25"
local unselected2 = "special_bonus_unique_abaddon_2"
local unselected3 = "special_bonus_cooldown_reduction_20"
local unselected4 = "special_bonus_unique_abaddon_3"
